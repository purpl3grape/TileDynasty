        ...
        public void OnSceneGUI() {
                            ...
                            switch (att.unwrapMethod) {
                                case UnwrapType.CubeProjection:
                                    for (int t = 0; t < att.meshFilter.sharedMesh.triangles.Length; t += 3) {
                                        ...
                                        Vector2 p1 = TextureTilingEditorWindow.sceneCamera.WorldToScreenPoint(att.transform.position + ((att.transform.rotation * Vector3.Scale(att.meshFilter.sharedMesh.vertices[vertexIndex1], att.transform.localScale))));
                                        Vector2 p2 = TextureTilingEditorWindow.sceneCamera.WorldToScreenPoint(att.transform.position + ((att.transform.rotation * Vector3.Scale(att.meshFilter.sharedMesh.vertices[vertexIndex2], att.transform.localScale))));
                                        Vector2 p3 = TextureTilingEditorWindow.sceneCamera.WorldToScreenPoint(att.transform.position + ((att.transform.rotation * Vector3.Scale(att.meshFilter.sharedMesh.vertices[vertexIndex3], att.transform.localScale))));
            ...
            if (TextureTilingEditorWindow.currentSelectedTriangles != null && TextureTilingEditorWindow.window != null) {
                ...
                if (TextureTilingEditorWindow.currentTextureTool != Tool.None && TextureTilingEditorWindow.selected != null 
                    && TextureTilingEditorWindow.selected.transform.localScale.x != 0f && TextureTilingEditorWindow.selected.transform.localScale.y != 0f && TextureTilingEditorWindow.selected.transform.localScale.z != 0f) {
                    bool changedAnything = false;
                    float amountX = 0f;
                    float amountY = 0f;
                    ...
                    switch (TextureTilingEditorWindow.selected.unwrapMethod) {
                        ...
                        case UnwrapType.FaceDependent:
                            if (TextureTilingEditorWindow.currentSelectedFaceIndex >= 0 && TextureTilingEditorWindow.currentSelectedFaceIndex < TextureTilingEditorWindow.selected.faceUnwrapData.Length) {
                                ...
                                Vector3 normal = new Vector3(selectedFace.AverageNormal.x / TextureTilingEditorWindow.selected.transform.localScale.x, selectedFace.AverageNormal.y / TextureTilingEditorWindow.selected.transform.localScale.y, selectedFace.AverageNormal.z / TextureTilingEditorWindow.selected.transform.localScale.z);
                                ...
                                center = TextureTilingEditorWindow.selected.transform.position + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.Scale((center / selectedFace.Triangles.Length), TextureTilingEditorWindow.selected.transform.localScale));
