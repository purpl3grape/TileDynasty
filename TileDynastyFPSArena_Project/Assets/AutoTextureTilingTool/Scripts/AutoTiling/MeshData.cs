...
namespace AutoTiling {
    ...
    public class MeshData {
        ...
        public void RemoveDoubles() {
            ...
            //for (int i = 0; i < triangles[0].Count; i += 3) {
            //    if (triangles[0][i] == 0 && triangles[0][i + 1] == 1 && triangles[0][i + 2] == 2) {
            //        newTriangleList[0] = new List<int>();
            //        newTriangleList[0].AddRange(triangles[0].GetRange(i, triangles[0].Count - i));
            //        newTriangleList[0].AddRange(triangles[0].GetRange(0, i));
            //        break;
            //    }
            //}
            triangles[0] = newTriangles;
            //Debug.Log("Triangles after rearrange: " + triangles[0].Count);
